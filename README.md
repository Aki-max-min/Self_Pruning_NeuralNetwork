...
| ------ | ----------------------------------------------------------------------------------------  |
| 1e-4   | Best practical balance; strong accuracy and high sparsity.                                |
| 5e-4   | Over-pruned for hard deployment; soft model still works but hard-pruned model collapses.  |
| 2e-3   | Far too aggressive; nearly all connections removed and hard-pruned model unusable.        |
